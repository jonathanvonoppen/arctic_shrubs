...
subtitle: <center>Primary analysis workflow | Topographic Wetness Index as wetness predictor</center>
...
* cover/abundance (as relative no. hits per plot for each species/group)
```{r}
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.groups.jags"))
```
...
model_out.shrub_gradient.AllShr <- jags(shrub_gradient_jags.AllShr.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.groups.jags"), 
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.AllShr2.jags"))
...
model_out.shrub_gradient.AllShr2 <- jags(shrub_gradient_jags.AllShr.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.AllShr2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
(effect_size_plot.AllShr2 <- model_plot_sig_function(coeff.shrub_gradient.AllShr2, title_string = "all shrubs", plot_width = 10.5))
```
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.AllEve2.jags"))
...
model_out.shrub_gradient.AllEve2 <- jags(shrub_gradient_jags.AllEve.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.AllEve2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.AllDec2.jags"))
...
model_out.shrub_gradient.AllDec2 <- jags(shrub_gradient_jags.AllDec.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.AllDec2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
(effect_size_plot.AllDec2 <- model_plot_sig_function(coeff.shrub_gradient.AllDec2, title_string = "deciduous shrubs", plot_width = 9.5))
```
* **positive/unimodal relationship with temperature variability, negative relationship with graminoid cover (sig.)**
* slightly positive relationship with temperature, solar radiation, wetness; negative relationship with terrain heterogeneity (n.s.)
...
shrub_gradient_jags.BetNan.data <- list(
  ...
  xhat_twi2 = as.numeric(c(quantile(BetNan.tot$twiC,0.05),
                           quantile(BetNan.tot$twiC,0.95))),
...
shrub_gradient_jags.CasTet.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(CasTet.tot$twiC,0.05),
                           quantile(CasTet.tot$twiC,0.95))),
...
shrub_gradient_jags.EmpNig.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(EmpNig.tot$twiC,0.05),
                           quantile(EmpNig.tot$twiC,0.95))),
...
shrub_gradient_jags.PhyCae.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(PhyCae.tot$twiC,0.05),
                           quantile(PhyCae.tot$twiC,0.95))),
...
shrub_gradient_jags.RhoGro.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(RhoGro.tot$twiC,0.05),
                           quantile(RhoGro.tot$twiC,0.95))),
...
shrub_gradient_jags.RhoTom.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(RhoTom.tot$twiC,0.05),
                           quantile(RhoTom.tot$twiC,0.95))),
...
shrub_gradient_jags.SalArc.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(SalArc.tot$twiC,0.05),
                           quantile(SalArc.tot$twiC,0.95))),
...
shrub_gradient_jags.SalGla.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(SalGla.tot$twiC,0.05),
                           quantile(SalGla.tot$twiC,0.95))),
...
shrub_gradient_jags.VacUli.data <- list(
  ...
  # ... and for predicting at high/low wetness and community acquisitiveness levels
  xhat_twi2 = as.numeric(c(quantile(VacUli.tot$twiC,0.05),
                           quantile(VacUli.tot$twiC,0.95))),
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.spec.jags"))
```
...
model_out.shrub_gradient.BetNan <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
(effect_size_plot.BetNan <- model_plot_sig_function(coeff.shrub_gradient.BetNan, title_string = "Betula nana", plot_width = 16.5))
```
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.BetNan2.jags"))
...
model_out.shrub_gradient.BetNan2 <- jags(shrub_gradient_jags.BetNan.data,   # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.BetNan2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
* **not converging**: relatively large R-hat values (~ 1.04) (only 16 non-zero values across plot groups)
...
# effect size plot
(effect_size_plot.EmpNig <- model_plot_sig_function(coeff.shrub_gradient.EmpNig, title_string = "Empetrum nigrum", plot_width = 16.5))

```

* slightly positive linear relationship to summer precipitation, slightly unimodal relationship with summer temperature and topographic wetness (n.s.)
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.EmpNig2.jags"))
...
model_out.shrub_gradient.EmpNig2 <- jags(shrub_gradient_jags.EmpNig.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.EmpNig2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
# effect size plot
(effect_size_plot.EmpNig2 <- model_plot_marg_function(coeff.shrub_gradient.EmpNig2, title_string = "Empetrum nigrum", plot_width = 11.5))

```

* **negative response to temperature variability (sig.)**, *positive response to other shrub cover, precipitation (linear) (m.s.)*
...
* **not converged** large R-hat values (~ 1.5) (only 10 non-zero values across plot groups)
...
* **negative response to graminoid cover, unimodal relationship with summer temperature (sig.)** 
* *positive relationship with temperature variability (m.s.)*
* slightly positive response to solar radiation, terrain heterogeneity, topographic wetness, and other shrub cover (n.s.)
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.RhoGro2.jags"))
...
model_out.shrub_gradient.RhoGro2 <- jags(shrub_gradient_jags.RhoGro.data,    # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.RhoGro2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
# effect size plot
(effect_size_plot.RhoGro2 <- model_plot_marg_function(coeff.shrub_gradient.RhoGro2, title_string = "Rhododendron groenlandicum", plot_width = 14.5))

```

* **positive response to temperature variability, unimodal response to summer temperature (sig) **
* *negative relationship with graminoid cover and precipitation (linear) (m.s.)*
...
* **not converging**: relatively large R-hat values (~ 1.3), large variation in parameter estimates (only 13 non-zero values)
...
#traceplot(model_out.shrub_gradient.SalArc)

save(coeff.shrub_gradient.SalArc, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_SalArc.Rdata"))

```

* **not converging well**: relatively high R-hat values (~ 1.05), and quite some variation in trace plots, especially for climatic parameters (only 13 non-zero values across plot groups)
...
* **positive relationship with less acquisitive communities and topographic wetness (sig.), other shrub cover and temperature variability (m.s.)**
* slightly negative response to graminoid cover and summer temperature (n.s.)
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.SalGla2.jags"))
...
model_out.shrub_gradient.SalGla2 <- jags(shrub_gradient_jags.SalGla.data,   # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.SalGla2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
* **positive relationship with conservative communities, other shrub cover, temperature variability (linear) and topographic wetness (sig.) **
* slightly positive relationship with terrain heterogeneity (n.s.)
...
# effect size plot
(effect_size_plot.VacUli <- model_plot_marg_function(coeff.shrub_gradient.VacUli, title_string = "Vaccinium uliginosum", plot_width = 16.5))

```

* **positive relationship with more conservative communities (sig.)** *and topographic wetness (m.s.)*
* slightly positive relationship with graminoid cover, slightly unimodal relationship with summer temperature (n.s.)
<br>
...
write("
  ...
  ", file.path("model_files_twi", "shrub_gradient.VacUli2.jags"))
...
model_out.shrub_gradient.VacUli2 <- jags(shrub_gradient_jags.VacUli.data,   # input data
                                        ...
                                        model.file = file.path("model_files_twi", "shrub_gradient.VacUli2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
# effect size plot
(effect_size_plot.VacUli2 <- model_plot_sig_function(coeff.shrub_gradient.VacUli2, title_string = "Vaccinium uliginosum", plot_width = 11.5))

```

* **positive relationship with more conservative communities (sig.)** 
* slightly positive relationship with graminoid cover, other shrub cover, temperature variability, and topographic wetness (n.s.)
