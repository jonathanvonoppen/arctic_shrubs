...
# Fig. S7.2) Effect size plots (TCWS) ----
...
# save plot
save_plot(file.path("analyses_tcws", "figures", "FigS7.2_effect_sizes_tcws.png"),
...
# Fig. S7.3) Interaction plots temp X moisture (TCWS) ----
...
# # >> save plot ----
save_plot(file.path("analyses_tcws", "figures", "FigS7.3_tempXwetness_tcws.png"),
...
# >> load function ----
source(file = file.path("scripts", "JvO", "plotting_functions", "prediction_plot.R"))
