---
title: 'Nuuk Fjord: Drivers of shrub abundance - analysis workflow'
...
Analyses conducted on fusion table at **plot $\times$ taxon level** (as we are explicitly interested in plot-level variation of predictors, esp. slope, solar radiation, terrain ruggedness, topographical wetness, and competition): 4968 observations for 66 variables
...
save(list = c("AllShr.tot",
              "AllEve.tot",
              "AllDec.tot"), 
     file = file.path("..", "data", "model_input_data", "shrub_gradient_group.datasets.Rdata"))
...
save(list = c("BetNan.tot",
              ...
              "SalGla.tot",
              "VacUli.tot"), 
     file = file.path("..", "data", "model_input_data", "shrub_gradient_species.datasets.Rdata"))
...
# save(coeff.shrub_gradient.AllShr, file = file.path("..", "data", "model_outputs", "groups", "first_runs_converged", "model_output_AllShr.Rdata"))
...
# save(coeff.shrub_gradient.AllEve, file = file.path("..", "data", "model_outputs", "groups", "first_runs_converged", "model_output_AllEve.Rdata"))
...
# save(coeff.shrub_gradient.AllDec, file = file.path("..", "data", "model_outputs", "groups", "first_runs_converged", "model_output_AllDec.Rdata"))
...
# save(coeff.shrub_gradient.BetNan, file = file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_BetNan.Rdata"))
# load(file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_BetNan.Rdata"))
...
# save(coeff.shrub_gradient.EmpNig, file = file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_EmpNig.Rdata"))
# load(file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_EmpNig.Rdata"))
...
# save(coeff.shrub_gradient.RhoGro, file = file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_RhoGro.Rdata"))
# load(file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_RhoGro.Rdata"))
...
# save(coeff.shrub_gradient.SalGla, file = file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_SalGla.Rdata"))
# load(file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_SalGla.Rdata"))
...
# save(coeff.shrub_gradient.VacUli, file = file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_VacUli.Rdata"))
# load(file.path("..", "data", "model_outputs", "species", "first_runs_converged", "model_output_VacUli.Rdata"))
