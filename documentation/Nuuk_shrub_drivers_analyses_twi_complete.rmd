...
subtitle: <center>- Analysis workflow -</center>
...
env_cov_bio_sub <- env_cov_bio %>% 
  ...
  inclin_down, sri, twi_fd8, twi_saga, tri, # environmental data
...
We'll go with TWI, as recommended by the reviewers. It should be least confounded by vegetation (unlike TCWS), though it might not represent actual moisture values very well. The FD8 algorithm-based values should at least do a better job at that than the SAGA algorithm-based index (see [Kopecky et al. 2020](https://doi.org/10.1016/j.prostaglandins.2020.106408)).
...
predictors_set <- env_cov_bio_sub %>% 
  select(ends_with("_ts_30"),   # CHELSA predictors averaged over 10-year period prior to study year
         inclin_down, sri, tri, twi_fd8,      # environmental data
...
save(list = c("AllShr.tot",
              "AllEve.tot",
              "AllDec.tot"),
     file = file.path("..", "data", "processed", "model_input_data_twi", "shrub_gradient_group.datasets.Rdata"))
...
save(list = c("BetNan.tot",
              ...
              "SalGla.tot",
              "VacUli.tot"),
     file = file.path("..", "data", "processed", "model_input_data_twi", "shrub_gradient_species.datasets.Rdata"))
...
shrub_gradient_jags.AllShr.data <- list(
  ...
  xhat_tri = seq(from = min(AllShr.tot$triC, na.rm = T), to = max(AllShr.tot$triC, na.rm = T), length.out = 100),
  xhat_twi = seq(from = min(AllShr.tot$twiC), to = max(AllShr.tot$twiC), length.out = 100),
  ...
  xhat_twi2 = as.numeric(c(quantile(AllShr.tot$twiC,0.05),quantile(AllShr.tot$twiC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.AllEve.data <- list(
  ...
  xhat_tri = seq(from = min(AllEve.tot$triC, na.rm = T), to = max(AllEve.tot$triC, na.rm = T), length.out = 100),
  xhat_twi = seq(from = min(AllEve.tot$twiC), to = max(AllEve.tot$twiC), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(AllEve.tot$twiC,0.05),quantile(AllEve.tot$twiC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.AllDec.data <- list(
  ...
  xhat_tri = seq(from = min(AllDec.tot$triC, na.rm = T), to = max(AllDec.tot$triC, na.rm = T), length.out = 100),
  xhat_twi = seq(from = min(AllDec.tot$twiC), to = max(AllDec.tot$twiC), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(AllDec.tot$twiC,0.05),quantile(AllDec.tot$twiC,0.95))), 
  Nxhat2 = 2
)
...
save(list = c("shrub_gradient_jags.AllShr.data",
     ...
     file = file.path("..", "data", "processed", "model_input_data_twi", "shrub_gradient_jags.groupdata.Rdata"))
```
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.groups.jags"))
```
...
model_out.shrub_gradient.AllShr <- jags(shrub_gradient_jags.AllShr.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.groups.jags"), 
...
save(coeff.shrub_gradient.AllShr, 
     file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "first_runs_converged", "model_output_AllShr.Rdata"))

(effect_size_plot.AllShr <- model_plot_sig_function(coeff.shrub_gradient.AllShr, title_string = "all shrubs", plot_width = 10.5))
```

* **unimodal response to summer temperature, negative response to graminoid cover (sig.)**
* slightly positive response to solar radiation (n.s.)

<br>

As precipitation and temp. variability quadratic terms didn't come out significant, re-run without them:
```{r, eval = FALSE}
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.AllShr2.jags"))
...
model_out.shrub_gradient.AllShr2 <- jags(shrub_gradient_jags.AllShr.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.AllShr2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.AllShr2, file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "model_output_AllShr2.Rdata"))

(effect_size_plot.AllShr2 <- model_plot_sig_function(coeff.shrub_gradient.AllShr2, title_string = "all shrubs", plot_width = 8.5))
```

* **positive response to temperature variability, unimodal response to summer temperature, negative response to graminoid cover (sig.)**
* positive response to solar radiation (n.s.)
...
save(coeff.shrub_gradient.AllEve, file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "first_runs_converged", "model_output_AllEve.Rdata"))
...
* **unimodal response to temperature, negative response to graminoid cover (sig.)**
* slightly positive response to solar radiation (n.s.)
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.AllEve2.jags"))
...
model_out.shrub_gradient.AllEve2 <- jags(shrub_gradient_jags.AllEve.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.AllEve2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.AllEve2, file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "model_output_AllEve2.Rdata"))
...
save(coeff.shrub_gradient.AllDec, file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "first_runs_converged", "model_output_AllDec.Rdata"))

(effect_size_plot.AllDec <- model_plot_marg_function(coeff.shrub_gradient.AllDec, title_string = "deciduous shrubs", plot_width = 10.5))
```

* **positive/unimodal response to summer temperature & temp. variability, negative response to graminoid cover (sig.)**
* slightly positive response to solar radiation, negative response to terrain heterogeneity (n.s.)
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.AllDec2.jags"))
...
model_out.shrub_gradient.AllDec2 <- jags(shrub_gradient_jags.AllDec.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.AllDec2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.AllDec2, file = file.path("..", "data", "processed", "model_outputs", "groups_twi", "model_output_AllDec2.Rdata"))
...
```
* **positive/unimodal response to temperature variability, positive response to soil moisture, negative response to graminoid cover (sig.)**
* *positive response to solar radiation (m.s.)*
* slightly positive response to temperature, negative response to terrain heterogeneity (n.s.)
...
shrub_gradient_jags.BetNan.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(BetNan.tot$competC, na.rm = T), to = max(BetNan.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(BetNan.tot$triC, na.rm = T), to = max(BetNan.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(BetNan.tot$twiC,0.05),quantile(BetNan.tot$twiC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.CasTet.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(CasTet.tot$competC, na.rm = T), to = max(CasTet.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(CasTet.tot$triC, na.rm = T), to = max(CasTet.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(CasTet.tot$tempjjaC,0.05),quantile(CasTet.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.EmpNig.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(EmpNig.tot$competC, na.rm = T), to = max(EmpNig.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(EmpNig.tot$triC, na.rm = T), to = max(EmpNig.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(EmpNig.tot$tempjjaC,0.05),quantile(EmpNig.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.PhyCae.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(PhyCae.tot$competC, na.rm = T), to = max(PhyCae.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(PhyCae.tot$triC, na.rm = T), to = max(PhyCae.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(PhyCae.tot$tempjjaC,0.05),quantile(PhyCae.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.RhoGro.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(RhoGro.tot$competC, na.rm = T), to = max(RhoGro.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(RhoGro.tot$triC, na.rm = T), to = max(RhoGro.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(RhoGro.tot$tempjjaC,0.05),quantile(RhoGro.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.RhoTom.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(RhoTom.tot$competC, na.rm = T), to = max(RhoTom.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(RhoTom.tot$triC, na.rm = T), to = max(RhoTom.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(RhoTom.tot$tempjjaC,0.05),quantile(RhoTom.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.SalArc.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(SalArc.tot$competC, na.rm = T), to = max(SalArc.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(SalArc.tot$triC, na.rm = T), to = max(SalArc.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(SalArc.tot$tempjjaC,0.05),quantile(SalArc.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.SalGla.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(SalGla.tot$competC, na.rm = T), to = max(SalGla.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(SalGla.tot$triC, na.rm = T), to = max(SalGla.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(SalGla.tot$tempjjaC,0.05),quantile(SalGla.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.VacUli.data <- list(
  ...
  # subset of values for prediction, for each predictor...
  xhat_compet = seq(from = min(VacUli.tot$competC, na.rm = T), to = max(VacUli.tot$competC, na.rm = T), length.out = 100),
  ...
  xhat_tri = seq(from = min(VacUli.tot$triC, na.rm = T), to = max(VacUli.tot$triC, na.rm = T), length.out = 100),
  ...
  # ... and for predicting at high/low temperature levels
  xhat_twi2 = as.numeric(c(quantile(VacUli.tot$tempjjaC,0.05),quantile(VacUli.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
save(list = c("shrub_gradient_jags.BetNan.data",
     ...
     file = file.path("..", "data", "processed", "model_input_data_twi", "shrub_gradient_jags.speciesdata.Rdata"))
```
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.spec.jags"))
```
...
model_out.shrub_gradient.BetNan <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.BetNan, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_BetNan.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_BetNan.Rdata"))
print(coeff.shrub_gradient.BetNan)
(effect_size_plot.BetNan <- model_plot_marg_function(coeff.shrub_gradient.BetNan, title_string = "Betula nana", plot_width = 12.5))
```

* **negative response to graminoid cover (sig.)** 
* *unimodal response to temp. variability & other shrub cover (m.s.)*
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.BetNan2.jags"))
...
model_out.shrub_gradient.BetNan2 <- jags(shrub_gradient_jags.BetNan.data,   # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.BetNan2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.BetNan2, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_BetNan2.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_BetNan2.Rdata"))

# effect size plot
(effect_size_plot.BetNan2 <- model_plot_marg_function(coeff.shrub_gradient.BetNan2, title_string = "Betula nana", plot_width = 9.5))

```

* **positive response to temperature variability, negative response to graminoid cover (sig.)**; *negative response to other shrub cover (m.s.)*
...
save(coeff.shrub_gradient.CasTet, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_CasTet.Rdata"))

```

* **not converging**: really large R-hat values (~ 6.8) (only 16 non-zero values across plot groups)
...
save(coeff.shrub_gradient.EmpNig, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_EmpNig.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_EmpNig.Rdata"))
...
* **positive response to other shrub cover, precipitation (linear), negative response to competition (sig.)**
* slightly negative response to graminoid cover, slightly positive relationship with moisture (n.s.)
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.EmpNig2.jags"))
...
model_out.shrub_gradient.EmpNig2 <- jags(shrub_gradient_jags.EmpNig.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.EmpNig2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.EmpNig2, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_EmpNig2.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_EmpNig2.Rdata"))
...
* **positive response to other shrub cover, precipitation (linear), negative response to competition & temperature variability (sig.)**
* negative response to graminoid cover, positive relationship with moisture (n.s.)
...
save(coeff.shrub_gradient.PhyCae, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_PhyCae.Rdata"))

```

* **not converged** large R-hat values (~ 1.36) (only 10 non-zero values across plot groups)
...
save(coeff.shrub_gradient.RhoGro, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_RhoGro.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_RhoGro.Rdata"))
...
* **positive response to other shrub cover, negative relationship with precipitation, unimodal response to temperature (sig.)** 
* *negative response to graminoid cover (m.s.)*
* slightly positive response to solar radiation, temperature variability (n.s.)
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.RhoGro2.jags"))
...
model_out.shrub_gradient.RhoGro2 <- jags(shrub_gradient_jags.RhoGro.data,    # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.RhoGro2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.RhoGro2, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_RhoGro2.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_RhoGro2.Rdata"))
...
* **positive response to temperature variability & other shrub cover, unimodal response to temperature and negative response to precipitation (linear) (sig) **
* *negative relationship with graminoid cover (n.s.)*
* positive response to solar radiation (n.s.)
* large variation in competiton response as there was only one (however rare) taller-growing species in the system (*R. tomentosum*)
...
save(coeff.shrub_gradient.RhoTom, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_RhoTom.Rdata"))

```

* **not converging**: large R-hat values (~ 1.38), large variation in parameter estimates (only 13 non-zero values)
...
save(coeff.shrub_gradient.SalArc, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_SalArc.Rdata"))

```

* **not converging well**: relatively large R-hat values (~ 1.37), quite some variation in parameter estimates (only 13 non-zero values across plot groups)
...
save(coeff.shrub_gradient.SalGla, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_SalGla.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_SalGla.Rdata"))
...
* **positive response to competition (sig.), negative response to other shrub cover (m.s.)**
* slightly negative response to temperature & solar radiation (n.s.)
...
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.SalGla2.jags"))
...
model_out.shrub_gradient.SalGla2 <- jags(shrub_gradient_jags.SalGla.data,   # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.SalGla2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.SalGla2, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_SalGla2.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_SalGla2.Rdata"))

# effect size plot
(effect_size_plot.SalGla2 <- model_plot_marg_function(coeff.shrub_gradient.SalGla2, title_string = "Salix glauca", plot_width = 9.5))

```

* **positive response to competition (sig.) and temperature variability (linear, m.s.); negative response to other shrub cover (m.s.)**
* positive response to moisture & terrain heterogeneity, negative response to solar radiation (n.s.)
...
save(coeff.shrub_gradient.VacUli, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_VacUli.Rdata"))
# load(file.path("..", "data", "processed", "model_outputs", "species_twi", "first_runs_converged", "model_output_VacUli.Rdata"))
...
* **unimodal relationship with summer temperature (sig.)**, *negative relationship with competition (m.s.)*

<br>

As the quadratic terms for summer precipitation and temperature variability were not significant, they were removed from the model before re-running:
```{r, eval = FALSE}
# new model object with terms removed
write("
  ...
  ", file.path("..", "models_twi", "shrub_gradient.VacUli2.jags"))
...
model_out.shrub_gradient.VacUli2 <- jags(shrub_gradient_jags.VacUli.data,   # input data
                                        ...
                                        model.file = file.path("..", "models_twi", "shrub_gradient.VacUli2.jags"), 
                                        n.chains = 3,                       # no. Markov chains
                                        n.iter = 100000, n.burnin = 70000,  # no. iterations & burn-in fraction per chain
                                        n.thin = 2,                         # thinning rate
                                        DIC = FALSE,                        # do not compute deviance, pD, and DIC
...
save(coeff.shrub_gradient.VacUli2, file = file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_VacUli2.Rdata"))
...
* *negative relationship with competition (m.s.)*
* negative relationship with moisture, positive response to solar radiation (n.s.)
