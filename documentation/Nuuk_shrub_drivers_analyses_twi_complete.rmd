...
* **positive response to soil moisture, negative response to graminoid cover (sig.)**
...
* **unimodal response to temperature, positive response to soil moisture, negative response to graminoid cover (sig.)**
* slightly positive response to solar radiation (n.s.)
...
```
* **unimodal response to temperature, positive response to soil moisture, negative response to graminoid cover & temperature variability (sig.)**
* slightly positive response to solar radiation (n.s.)
...
* **positive/unimodal response to temperature variability, negative response to graminoid cover (sig.)**
...
* **negative response to graminoid cover (sig.)** and *other shrub cover (m.s.)*
...
# save(coeff.shrub_gradient.BetNan2, file.path("..", "data", "processed", "model_outputs", "species_twi", "model_output_BetNan2.Rdata"))
...
* **positive response to other shrub cover, precipitation (linear) & soil moisture, negative response to competition (sig.)**
* negative response to graminoid cover, terrain heterogeneity (n.s.)
...
* **positive response to other shrub cover, precipitation (linear) & soil moisture, negative response to competition & temperature variability (sig.)**
* negative response to graminoid cover, terrain heterogeneity (n.s.)
...
* **not converged** large R-hat values (~ 1.4) (only 10 non-zero values across plot groups)
...
* **positive response to other shrub cover (sig.), unimodal response to temperature (m.s.)** 
* slightly positive response to solar radiation, temperature variability (n.s.)
* slightly negative response to graminoid cover & predipitation (n.s.)
...
* **positive response to temperature variability & other shrub cover (sig.), unimodal response to temperature and negative response to precipitation (linear) (m.s.) **
* positive response to solar radiation (n.s.)
* large variation in competiton response as there was only one (however rare) taller-growing species in the system (*R. tomentosum*)
...
* **not converging**: large R-hat values (~ 1.3), large variation in parameter estimates (only 13 non-zero values)
...
* **not converging well**: relatively large R-hat values (~ 1.09), quite some variation in parameter estimates (only 13 non-zero values across plot groups)
...
* positive response to soil moisture, negative response to solar radiation (n.s.)
...
* **positive response to soil moisture (sig.)**, *precipitation, temperature (m.s.); negative response to competition (m.s.)*

<br>

As the quadratic terms for all climate variables were not significant, they were removed from the model before re-running:
```{r, eval = FALSE}
# new model object with terms removed
write("
...
* **positive response to soil moisture (sig.)**, *precipitation, temperature (m.s.)*
* negative response to competition & terrain heterogeneity, positive response to solar radiation (n.s.)
