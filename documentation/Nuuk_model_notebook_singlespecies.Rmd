...
# effect size plot
(effect_size_plot.RhoGro <- model_plot_marg_function(coeff.shrub_gradient.RhoGro, title_string = "Rhododendron groenlandicum"))

```

* **negative response to temperature (quadratic, strongly sig.)** & *precipitation (linear, m.s.)* 
...
* **negative response to temperature (quadratic, sig.)**, *TWI (m.s.)*, competition (n.s.)
