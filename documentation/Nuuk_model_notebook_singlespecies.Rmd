...
shrub_gradient_jags.AllShr.data <- list(
  ...
  tempjja.tot.plot = AllShr$tempjjaC,
...
shrub_gradient_jags.AllEve.data <- list(
  ...
  tempjja.tot.plot = AllEve$tempjjaC,
...
shrub_gradient_jags.AllDec.data <- list(
  ...
  tempjja.tot.plot = AllDec$tempjjaC,
      ...
      for (m in 1:Nxhat){
        ...
        for (p in 1:Nxhat2){
          phat_tempXmoist[m,p] <- intercept +
                                      ...
                                      b.tempXtcws2 * (xhat_tempjja[m]^2) * xhat_tcws2[m]
        }
    ...
    # LIKELIHOOD for continuous part
      ...
      for (j in 1:N_cont){
        ...
        logit(mu2[j]) <- b_plotgroup[plotgroup.cont[j]] + # ~= random effect of plot group
                        ...
                        b.tempXtcws * tempjja.cont[i] * tcws.cont[i] +       # for interaction
                        b.tempXtcws2 * (tempjja.cont[i]^2) * tcws.cont[i] +  # for interaction
                        b.tcws * tcws.cont[j] + 
                        b.sri * sri.cont[j] +
                        b.tri * tri.cont[j]
      }
