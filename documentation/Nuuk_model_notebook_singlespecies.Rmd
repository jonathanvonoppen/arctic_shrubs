...
(effect_size_plot.BetNan <- model_plot_function(coeff.shrub_gradient.BetNan))
```
...
# effect size plot
(effect_size_plot.EmpNig <- model_plot_function(coeff.shrub_gradient.EmpNig))
...
# effect size plot
(effect_size_plot.RhoGro <- model_plot_function(coeff.shrub_gradient.RhoGro))
...
# effect size plot
(effect_size_plot.SalGla <- model_plot_function(coeff.shrub_gradient.SalGla))
...
# effect size plot
(effect_size_plot.VacUli <- model_plot_function(coeff.shrub_gradient.VacUli))
