...
```{r}
model_out.shrub_gradient.CasTet <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.EmpNig <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.PhyCae <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.RhoGro <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.RhoTom <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.SalArc <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.SalGla <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
...
```{r}
model_out.shrub_gradient.VacUli <- jags(shrub_gradient_jags.BetNan.data,    # input data
                                        inits = NULL,                       # JAGS to create initial values
                                        params,                             # parameters to be saved
                                        model.file = file.path("models", "shrub_gradient.spec.jags"), 
                                        n.chains = 3,                       # no. Markov chains
