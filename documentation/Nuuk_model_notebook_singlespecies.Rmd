...
shrub_gradient_jags.SalGla.data <- list(
  ...
  xhat_shrub_cover = seq(from = min(SalGla.tot$shrub_coverC), to = max(SalGla.tot$shrub_coverC), length.out = 100),
...
save(coeff.shrub_gradient.BetNan, file = file.path("..", "data", "model_outputs", "model_output_BetNan.Rdata"))
...
save(coeff.shrub_gradient.BetNan2, file.path("..", "data", "processed", "model_outputs", "model_output_BetNan2.Rdata"))
...
save(coeff.shrub_gradient.CasTet, file = file.path("..", "data", "model_outputs", "model_output_CasTet.Rdata"))
...
save(coeff.shrub_gradient.EmpNig, file = file.path("..", "data", "model_outputs", "model_output_EmpNig.Rdata"))
...
save(coeff.shrub_gradient.EmpNig2, file = file.path("..", "data", "model_outputs", "model_output_EmpNig2.Rdata"))
...
save(coeff.shrub_gradient.PhyCae, file = file.path("..", "data", "model_outputs", "model_output_PhyCae.Rdata"))
...
save(coeff.shrub_gradient.RhoGro, file = file.path("..", "data", "model_outputs", "model_output_RhoGro.Rdata"))

# effect size plot
(effect_size_plot.RhoGro <- model_plot_sig_function(coeff.shrub_gradient.RhoGro, title_string = "Rhododendron groenlandicum", plot_width = 12.5))
...
save(coeff.shrub_gradient.RhoGro2, file = file.path("..", "data", "model_outputs", "model_output_RhoGro2.Rdata"))

# effect size plot
(effect_size_plot.RhoGro2 <- model_plot_sig_function(coeff.shrub_gradient.RhoGro2, title_string = "Rhododendron groenlandicum", plot_width = 10.5))
...
save(coeff.shrub_gradient.RhoTom, file = file.path("..", "data", "model_outputs", "model_output_RhoTom.Rdata"))
...
save(coeff.shrub_gradient.SalArc, file = file.path("..", "data", "model_outputs", "model_output_SalArc.Rdata"))
...
save(coeff.shrub_gradient.SalGla, file = file.path("..", "data", "model_outputs", "model_output_SalGla.Rdata"))
...
save(coeff.shrub_gradient.SalGla2, file = file.path("..", "data", "model_outputs", "model_output_SalGla2.Rdata"))
...
save(coeff.shrub_gradient.VacUli, file = file.path("..", "data", "model_outputs", "model_output_VacUli.Rdata"))
