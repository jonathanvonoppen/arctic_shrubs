...
```{r}
# new model object with compet removed
write("
  ...
  ", file.path("..", "models", "shrub_gradient.RhoGro.jags"))

# specify new set of parameters to be monitored
params_RhoGro <- c("intercept",
            "b.tempjja.x", "b.tempjja.x2",
            "b.tempcont.x", "b.tempcont.x2",
            "b.precipjja.x", "b.precipjja.x2",
            # "b.compet",
...
# load(file.path("..", "data", "model_outputs", "model_output_VacUli.Rdata"))
