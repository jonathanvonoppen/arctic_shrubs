...
shrub_gradient_jags.groupdata <- list(shrub_gradient_jags.AllShr.data,
                                      shrub_gradient_jags.AllEve.data,
                                      shrub_gradient_jags.AllDec.data)

save(shrub_gradient_jags.groupdata, file = file.path("..", "data", "model_input_data", "shrub_gradient_jags.groupdata.Rdata"))
```
...
(effect_size_plot.AllShr2 <- model_plot_sig_function(coeff.shrub_gradient.AllShr2, title_string = "all shrubs", plot_width = 11))
```
...
(effect_size_plot.AllEve2 <- model_plot_sig_function(coeff.shrub_gradient.AllEve2, title_string = "evergreen shrubs", plot_width = 11))
```
...
(effect_size_plot.AllDec2 <- model_plot_sig_function(coeff.shrub_gradient.AllDec2, title_string = "deciduous shrubs", plot_width = 11))
```
...
# save model input data
shrub_gradient_jags.speciesdata <- list(shrub_gradient_jags.BetNan.data,
...
save(shrub_gradient_jags.speciesdata, file = file.path("..", "data", "model_input_data", "shrub_gradient_jags.speciesdata.Rdata"))
```
