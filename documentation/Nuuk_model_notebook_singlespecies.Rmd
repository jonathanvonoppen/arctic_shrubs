...
shrub_gradient_jags.BetNan.data <- list(
  ...
  xhat_tempjja2 = as.numeric(c(quantile(BetNan.tot$tempjjaC,0.05),quantile(BetNan.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
str(shrub_gradient_jags.BetNan.data)
...
shrub_gradient_jags.CasTet.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(CasTet.tot$tempjjaC,0.05),quantile(CasTet.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.EmpNig.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(EmpNig.tot$tempjjaC,0.05),quantile(EmpNig.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.PhyCae.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(PhyCae.tot$tempjjaC,0.05),quantile(PhyCae.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.RhoGro.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(RhoGro.tot$tempjjaC,0.05),quantile(RhoGro.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.RhoTom.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(RhoTom.tot$tempjjaC,0.05),quantile(RhoTom.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.SalArc.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(SalArc.tot$tempjjaC,0.05),quantile(SalArc.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.SalGla.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(SalGla.tot$tempjjaC,0.05),quantile(SalGla.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
...
shrub_gradient_jags.VacUli.data <- list(
  ...
  # ... and for predicting at high/low temperature levels
  xhat_tempjja2 = as.numeric(c(quantile(VacUli.tot$tempjjaC,0.05),quantile(VacUli.tot$tempjjaC,0.95))), 
  Nxhat2 = 2
)
