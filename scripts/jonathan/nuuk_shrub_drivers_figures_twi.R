...
# # >> save plot ----
# save_plot(file.path("figures", "nuuk_shrub_drivers_interaction_panels_vert_twi.png"),
...
# # >> save plot ----
save_plot(file.path("figures", "nuuk_shrub_drivers_tempXinteraction.png"),
...
# Fig. S XXX.1) Effect size plots (TWI) ----
...
# Fig. S XXX.2ff) Groups: cover and predictions for all predictors ----
...
# Fig. S XXX.5ff) Species: cover and predictions for all predictors (TWI) ----
