...
env_cov_bio_sub <- env_cov_bio_sub[env_cov_bio_sub$taxon %in% c("Cassiope tetragona", "Phyllodoce caerulea") == F,]
...
shrub_gradient_jags.data <- list(
  ...
  # UV_site.tot = env_cov_bio_sub$site.NUM[!duplicated(env_cov_bio_sub$taxon_plotgroup.NUM)], #one value per tXpg
