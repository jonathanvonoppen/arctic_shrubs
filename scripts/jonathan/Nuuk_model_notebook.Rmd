...
### b) Abundance check & selection of taxa
...
To improve the chance of model convergence, we remove *Cassiope tetragona* & *Phyllodoce coerulea* (moving down the list):
```{r}
...
-> re-try with breaking up the model for the separate species
...
[subsetting, data compilation, model, output]